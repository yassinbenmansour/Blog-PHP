            ...
            <div class="row justify-content-center">
                <form class="mx-1 mx-md-4" action="#" method="post">
                    ...
                    if (isset($_POST['submit'])) {
                        $newCateg = mysqli_escape_string($con, $_POST['categorie']);
                        $author = mysqli_escape_string($con, $_SESSION['Name']);

                        $changeSql = "UPDATE categories SET name='$newCateg',added_by='$author' WHERE id = $id";
                    ...
                    <div>
                        <input type="submit" name="submit" class="btn btn-primary btn-lg" value="change"></input>
                    </div>
