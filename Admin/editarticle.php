...
<div class="container" style="width:80%;height:100%; padding-left:20% ; margin-top:-800px;">
    <h1 class="text-primary">Edit article </h1>
    <hr>
...
if(isset($_POST['submit'])){
  ...
  if(empty($title)){
    ...
    $erreur = "Veillez choisi  une image  ";
  }else{
    $sql = "UPDATE articles SET category_id = '$categorie', title='$title',body='$body',image='avatar.jpg',author='$author',created='$created' WHERE id = $ida";
                ...
                <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <label for="">Categorie</label>
                      ...
                      <?php 
                        ...
                        <?php echo $catego['id'] == $article['category_id'] ? "selected" : '' ;?>
                        >
